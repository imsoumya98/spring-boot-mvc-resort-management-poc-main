...
import com.poc.resortmanagementsystem.entity.Role;
import com.poc.resortmanagementsystem.entity.User;
import com.poc.resortmanagementsystem.repository.UserRepository;
...
public class UserServiceImpl implements UserService{
    ...
    public User save(UserRegistrationDto registrationDto) {
        User user = new User(registrationDto.getFirstName(),
                ...
                passwordEncoder.encode(registrationDto.getPassword()), Arrays.asList(new Role("ROLE_USER")).stream().collect(Collectors.toSet()));
